    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12 bg-gray-100 p-8 rounded-lg shadow-md">
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-1 pl-4">
            ...
            <li><strong>Seconde Chambre :</strong> Parfaite pour un enfant ou un adulte, cette chambre est équipée d’un lit simple, offrant un petit espace fermé.</li>
          </ul>
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-1 pl-4">
            ...
            <li><strong>Une Salle de Bains :</strong> Equipée d'une baignoire. Un véritable atout pour des moments de relaxation.</li>
          </ul>
        </div>
      ...
      <section className="text-center py-12 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg shadow-xl">
        ...
        <div className="bg-white text-gray-800 p-6 rounded-lg shadow-md max-w-md mx-auto">
          ...
          <a href="mailto:birdie.deauville@gmail.com" className="text-xl font-bold text-blue-600 hover:underline">birdie.deauville@gmail.com</a></p>
           <p className="text-xl font-bold text-blue-600 hover:underline"> 07 56 85 18 46</p>
